...
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_I14443a[][2] =
{
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_PN512_DEFAULT_TIMEOUT},
...
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_I14443b[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_PN512_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_PN512_MODINDEX_I14443B},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/* Default shadow for FeliCa Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_Felica[][2] =
{
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_PN512_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_PN512_MODINDEX_FELICA},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/* Default shadow for FeliCa Mode at 424 baud rate */
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_Felica_424[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_I18092mPI[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_I18092mPI_212[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_I18092mPI_424[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
static const uint16_t PH_MEMLOC_CONST_ROM wPn512_DefaultShadow_I18092mPT[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
{
    if (sizeof(phhalHw_Pn512_DataParams_t) != wSizeOfDataParams)
    {
    ...
    /* Init. private data */
    pDataParams->wId                    = PH_COMP_HAL | PHHAL_HW_PN512_ID;
    ...
    pDataParams->wMaxPrecachedBytes     = PHHAL_HW_PN512_PRECACHED_BYTES;
    ...
    return phbalReg_SetConfig(pDataParams->pBalDataParams, PHBAL_REG_CONFIG_HAL_HW_TYPE, PHBAL_REG_HAL_HW_PN512);
}
                                  ...
                                  )
{
    ...
    status = phhalHw_Pn512_ExchangeTransmit(pDataParams, PHHAL_HW_PN512_CMD_TRANSCEIVE, pTxBuffer, wTxLength);
    ...
    {
        status = phhalHw_Pn512_ExchangeReceive(pDataParams, wOption, ppRxBuffer, pRxLength);
    }
    ...
    )
{
    ...
    if (bCardType != PHHAL_HW_CARDTYPE_CURRENT)
    {
        ...
        memset(pDataParams->wCfgShadow, 0x00, PHHAL_HW_PN512_SHADOW_COUNT);  /* PRQA S 3200 */
    }
    else
    {
        bUseDefaultShadow = 0;
    ...
    case PHHAL_HW_CARDTYPE_ISO14443A:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXMODE, PHHAL_HW_PN512_BIT_MIFARE));
        /* configure Rx path for ISO14443A */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, PHHAL_HW_PN512_BIT_MIFARE));
        /* configurate default TxModWidth */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_MODWIDTH, 0x26));
        /* configure the RxThreshold for ISO14443A */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXTHRESHOLD, PHHAL_HW_PN512_RXTHRESHOLD_I14443A));
        /* Set initiator mode */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_CONTROL, PHHAL_HW_PN512_BIT_INITIATOR));

        /* Use 14443a default shadow */
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I14443a;
        wShadowCount = sizeof(wPn512_DefaultShadow_I14443a) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_ISO14443B:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXMODE, PHHAL_HW_PN512_BIT_TYPEB));
        /* configure Rx path for ISO14443B */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, PHHAL_HW_PN512_BIT_TYPEB));
        /* configure the RxThreshold for ISO14443B */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXTHRESHOLD, PHHAL_HW_PN512_RXTHRESHOLD_I14443B));
        /* Set TypeB register to default */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TYPEB, 0x00));
        /* Set initiator mode */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_CONTROL, PHHAL_HW_PN512_BIT_INITIATOR));

        /* Use 14443b shadow */
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I14443b;
        wShadowCount = sizeof(wPn512_DefaultShadow_I14443b) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_FELICA:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXMODE, PHHAL_HW_PN512_BIT_FELICA));
        /* configure Rx path for Felica */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, PHHAL_HW_PN512_BIT_FELICA));
        /* configure the RxThreshold for Felica  */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXTHRESHOLD, PHHAL_HW_PN512_RXTHRESHOLD_FELICA));
        /* Set initiator mode */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_CONTROL, PHHAL_HW_PN512_BIT_INITIATOR));

        /* Use Felica shadow */
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_Felica;
        wShadowCount = sizeof(wPn512_DefaultShadow_Felica) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_I18092MPI:
        ...
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I18092mPI;
        wShadowCount = sizeof(wPn512_DefaultShadow_I18092mPI) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_I18092MPI_212:
        ...
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I18092mPI_212;
        wShadowCount = sizeof(wPn512_DefaultShadow_I18092mPI_212) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_I18092MPI_424:
        ...
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I18092mPI_424;
        wShadowCount = sizeof(wPn512_DefaultShadow_I18092mPI_424) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_I18092MPT:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXTHRESHOLD, PHHAL_HW_PN512_RXTHRESHOLD_I14443A));
        /* Set target mode */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_CONTROL, 0x00));
        /* Switch off the field */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, 0x00));
        /* Use TypeA shadow by default */
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I18092mPT;
        wShadowCount = sizeof(wPn512_DefaultShadow_I18092mPT) / (sizeof(uint16_t) * 2);
        break;
    ...
    case PHHAL_HW_CARDTYPE_FELICA_424:
        ...
        /* Use Felica shadow */
        pShadowDefault = (uint16_t*)wPn512_DefaultShadow_Felica_424;
        wShadowCount = sizeof(wPn512_DefaultShadow_Felica_424) / (sizeof(uint16_t) * 2);
        break;
    ...
    if(pDataParams->bCardType == PHHAL_HW_CARDTYPE_I18092MPT)
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RFCFG, 0x59));
    }
    else
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RFCFG, 0x59));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, &bValue));
    bValue  = PHHAL_HW_PN512_BIT_TX2RFEN | PHHAL_HW_PN512_BIT_TX1RFEN;
    bValue |= PHHAL_HW_PN512_BIT_INVTX2ON | PHHAL_HW_PN512_BIT_CHECKRF;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, bValue));

    /* configure the RxSel Register */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXSEL, 0x80));

    /* configure general settings */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_MODE, 0x00));

    /* configure the conductance if no modulation is active */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_GSN, 0xFF));
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_CWGSP, 0x3F));

    /* configure the conductance for LoadModulation */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_GSNOFF, PHHAL_HW_PN512_MODINDEX_TARGET));

    /* reset bitframing register */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_BITFRAMING, 0x00));

    if(pDataParams->bCardType == PHHAL_HW_CARDTYPE_I18092MPT)
    {
        /* configure the timer */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TMODE, 0x00));
    }
    else
    {
        /* configure the timer */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TMODE, PHHAL_HW_PN512_BIT_TAUTO));
    }

    /* configure the water level */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_WATERLEVEL, PHHAL_HW_PN512_FIFOSIZE - 8));
    ...
    for (wIndex = 0; wIndex < wShadowCount; ++wIndex)
    {
            ...
            (pDataParams->bTimeoutUnit != PHHAL_HW_TIME_MILLISECONDS))))
        {
            ...
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetConfig(pDataParams, wConfig, pShadowDefault[(wIndex << 1) + 1]));
            }
            /* Current shadow: */
            else
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetConfig(pDataParams, wConfig, pDataParams->wCfgShadow[wConfig]));
            }
        }
    }
                                   ...
                                   )
{
    ...
    case PHHAL_HW_CONFIG_PARITY:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_MFRX, &bRegister));

        if (wValue == PH_OFF)
        {
            bValue = bRegister | PHHAL_HW_PN512_BIT_PARITYDISABLE;
        }
        else
        {
            bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_PN512_BIT_PARITYDISABLE;
        }

        /* Only perform the operation, if the new value is different */
        if (bValue != bRegister)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_MFRX, bValue));
        }
    ...
    case PHHAL_HW_CONFIG_TXCRC:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_TXMODE, &bRegister));

        if (wValue == PH_OFF)
        {
            bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_PN512_BIT_CRCEN;
        }
        else
        {
            bValue = bRegister | PHHAL_HW_PN512_BIT_CRCEN;
        }

        /* Only perform the operation, if the new value is different */
        if (bValue != bRegister)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXMODE, bValue));
        }
    ...
    case PHHAL_HW_CONFIG_RXCRC:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, &bRegister));
        ...
        if (bValue != bRegister)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, bValue));
        }
    ...
    case PHHAL_HW_CONFIG_TXLASTBITS:
        ...
        /* check parameter */
        if (wValue > PHHAL_HW_PN512_MASK_TXBITS)
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }

        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_BITFRAMING, &bRegister));
        bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_TXBITS;
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_BITFRAMING, bRegister | (uint8_t)wValue));
    ...
    case PHHAL_HW_CONFIG_RXALIGN:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_BITFRAMING, &bRegister));
        bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_RXALIGN;
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_BITFRAMING, bRegister |  (uint8_t)wValue));
    ...
    case PHHAL_HW_CONFIG_RXDEAFBITS:
        ...
        /* check parameter */
        if (wValue > PHHAL_HW_PN512_MASK_RXWAIT)
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }

        /* configure the Rx Deaf Time in bits */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_RXSEL, &bRegister));
        bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_RXWAIT;
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXSEL, bRegister |  (uint8_t)wValue));
    ...
    case PHHAL_HW_CONFIG_TXDATARATE:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_TXMODE, &bRegister));
        bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_SPEED;

        /* update current data rate */
        switch (wValue)
        {
        case PHHAL_HW_RF_DATARATE_106:
            bValue |= PHHAL_HW_PN512_BIT_106KBPS;
            bModWidthReg = 0x26;
            break;
        case PHHAL_HW_RF_DATARATE_212:
            bValue |= PHHAL_HW_PN512_BIT_212KBPS;
            bModWidthReg = 0x15;
            break;
        case PHHAL_HW_RF_DATARATE_424:
            bValue |= PHHAL_HW_PN512_BIT_424KBPS;
            bModWidthReg = 0x0A;
            break;
        case PHHAL_HW_RF_DATARATE_848:
            bValue |= PHHAL_HW_PN512_BIT_848KBPS;
            bModWidthReg = 0x05;
            break;
        default:
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        ...
        case PHHAL_HW_CARDTYPE_I18092MPT:
            ...
            if (wValue == PHHAL_HW_RF_DATARATE_106)
            {
                ...
                if ((bRegister & PHHAL_HW_PN512_MASK_SPEED) != PHHAL_HW_RF_DATARATE_106)
                {
                    /* Update RxThreshold*/
                    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_RXTHRESHOLD, PHHAL_HW_PN512_RXTHRESHOLD_I14443A));

                    /* Update Framing */
                    bValue &= (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_FRAMING;
                    bValue |= PHHAL_HW_PN512_BIT_MIFARE;

                    /* Set shadow */
                    pShadowDefault = (uint16_t*)wPn512_DefaultShadow_I14443a;
                    wBufferLen = sizeof(wPn512_DefaultShadow_I14443a) / (sizeof(uint16_t) * 2);
                }
            }
            ...
            else if (wValue < PHHAL_HW_RF_DATARATE_848)
            {
                ...
                if ((bRegister & PHHAL_HW_PN512_MASK_SPEED) == PHHAL_HW_RF_DATARATE_106)
                {
                    ...
                    /* Update Framing */
                    bValue &= (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_FRAMING;
                    bValue |= PHHAL_HW_PN512_BIT_FELICA;

                    /* Set shadow */
                    pShadowDefault = (uint16_t*)wPn512_DefaultShadow_Felica;
                    wBufferLen = sizeof(wPn512_DefaultShadow_Felica) / (sizeof(uint16_t) * 2);
                }
            }
        ...
        if (bValue != bRegister)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_MODWIDTH, bModWidthReg));
        }
    ...
    case PHHAL_HW_CONFIG_MODINDEX:
        ...
        if (wValue & (uint8_t)~(uint8_t)PHHAL_HW_PN512_MASK_MODGSP)
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }

        /* Set ModGsP register */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_MODGSP, (uint8_t)wValue));
    ...
    case PHHAL_HW_CONFIG_ASK100:
        ...
        if (wValue == PH_OFF)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXASK, 0x00));
        }
        /* switch on 100% ASK */
        else
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXASK, PHHAL_HW_PN512_BIT_FORCE100ASK));
        }
    ...
    case PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS:
        ...
        if (wConfig == PHHAL_HW_CONFIG_TIMEOUT_VALUE_US)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetFdt(pDataParams, PHHAL_HW_TIME_MICROSECONDS, wValue));
            pDataParams->bTimeoutUnit = PHHAL_HW_TIME_MICROSECONDS;
        }
        /* Calculate values for Millisecond values */
        else
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetFdt(pDataParams, PHHAL_HW_TIME_MILLISECONDS, wValue));
            pDataParams->bTimeoutUnit = PHHAL_HW_TIME_MILLISECONDS;
        }
    ...
    case PHHAL_HW_CONFIG_DISABLE_MF_CRYPTO1:
        ...
        if (wValue != PH_OFF)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_STATUS2, &bRegister));

            /* Clear Crypto1On bit */
            bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_PN512_BIT_CRYPTO1ON;

            /* Only perform the operation, if the new value is different */
            if (bValue != bRegister)
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_STATUS2, bValue));
            }
        }
        break;
    ...
    case PHHAL_HW_CONFIG_TXBUFFER_LENGTH:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_GetTxBuffer(pDataParams, PH_ON, &pBuffer, &wBufferLen, &wBufferSize));
    ...
    case PHHAL_HW_CONFIG_MAX_PRECACHED_BYTES:
        ...
        if (wValue > PHHAL_HW_PN512_FIFOSIZE)
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
    ...
    case PHHAL_HW_CONFIG_SERIAL_BITRATE:
        ...
        case PHHAL_HW_RS232_BITRATE_9600:
            bValue = PHHAL_HW_PN512_SERIALSPEED_9600;
            break;
        case PHHAL_HW_RS232_BITRATE_19200:
            bValue = PHHAL_HW_PN512_SERIALSPEED_19200;
            break;
        case PHHAL_HW_RS232_BITRATE_38400:
            bValue = PHHAL_HW_PN512_SERIALSPEED_38400;
            break;
        case PHHAL_HW_RS232_BITRATE_57600:
            bValue = PHHAL_HW_PN512_SERIALSPEED_57600;
            break;
        case PHHAL_HW_RS232_BITRATE_115200:
            bValue = PHHAL_HW_PN512_SERIALSPEED_115200;
            break;
        case PHHAL_HW_RS232_BITRATE_230400:
            bValue = PHHAL_HW_PN512_SERIALSPEED_230400;
            break;
        case PHHAL_HW_RS232_BITRATE_460800:
            bValue = PHHAL_HW_PN512_SERIALSPEED_460800;
            break;
        default:
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_SERIALSPEED, bValue));
        break;
    ...
    case PHHAL_HW_CONFIG_SETMINFDT:
        ...
        phhalHw_Pn512_SetMinFDT(pDataParams, wValue);
        break;
    ...
    case PHHAL_HW_CONFIG_RXMULTIPLE:
        ...
        if (wValue == PH_ON)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp,
                ...
                pDataParams,
                PHHAL_HW_PN512_REG_RXMODE,
                &bRegister));
            bRegister |= PHHAL_HW_PN512_BIT_RXMULTIPLE;

            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_Pn512_WriteRegister(
                pDataParams,
                PHHAL_HW_PN512_REG_RXMODE,
                bRegister
                ));
    ...
    case PHHAL_HW_CONFIG_ACTIVEMODE:
        if (wValue == PH_ON)
        {
            ...
            bSpeed = (bRegister & PHHAL_HW_PN512_MASK_SPEED);
            if (bSpeed == PHHAL_HW_RF_DATARATE_106)
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    ...
                    pDataParams,
                    PHHAL_HW_PN512_REG_TXBITPHASE,
                    0x0F));

                /* Set Force100ASK */
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_TXASK, &bRegister));

                bRegister |= 0x40;
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    phhalHw_WriteRegister(
                    pDataParams,
                    PHHAL_HW_PN512_REG_TXASK,
                    bRegister));
            }
            else
            {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_ReadRegister(
                pDataParams,
                PHHAL_HW_PN512_REG_MODE,
                &bRegister));
            bRegister |= PHHAL_HW_PN512_BIT_DETECT_SYNC;
            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_WriteRegister(
                pDataParams,
                PHHAL_HW_PN512_REG_MODE,
                ...
                (pDataParams->bCardType == PHHAL_HW_CARDTYPE_I18092MPI_424))
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    phhalHw_ReadRegister(
                    pDataParams,
                    PHHAL_HW_PN512_REG_TXMODE,
                    &bRegister));

                bRegister &= 0xFC;
                bRegister |= PHHAL_HW_PN512_BIT_ACTIVE;
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    phhalHw_WriteRegister(
                    pDataParams,
                    PHHAL_HW_PN512_REG_TXMODE,
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    ...
                    PHHAL_HW_PN512_REG_TXASK,
                    &bRegister));
                bRegister &= ~(PHHAL_HW_PN512_BIT_CA_ON);
                ...
                bRegister |= (PHHAL_HW_PN512_BIT_TX2RFAutoEN | PHHAL_HW_PN512_BIT_TX1RFAutoEN
                    | PHHAL_HW_PN512_BIT_AUTORF_OFF);
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    phhalHw_WriteRegister(
                    pDataParams,
                    PHHAL_HW_PN512_REG_TXASK,
            ...
            else
            {
                ...
                bRegister = (PHHAL_HW_PN512_BIT_ACTIVE | bSpeed | PHHAL_HW_PN512_BIT_CRCEN);
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    phhalHw_WriteRegister(
                    pDataParams,
                    PHHAL_HW_PN512_REG_TXMODE,
                ...
                bRegister |= PHHAL_HW_PN512_BIT_TXWAITRF;
                PH_CHECK_SUCCESS_FCT(statusTmp,
                    phhalHw_WriteRegister(
                    pDataParams,
                    PHHAL_HW_PN512_REG_MODE,
    ...
    case PHHAL_HW_CONFIG_MFHALTED:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_ReadRegister(
            pDataParams,
            PHHAL_HW_PN512_REG_MFTX,
            &bRegister));

        if(wValue == PH_ON)
        {
            bRegister |= PHHAL_HW_PN512_BIT_MFHALTED;
        }
        else
        {
            bRegister &= ~PHHAL_HW_PN512_BIT_MFHALTED;
                                   ...
                                   )
{
    ...
    case PHHAL_HW_CONFIG_DISABLE_MF_CRYPTO1:
        ...
        /* Check Crypto1On bit */
        if (bRegister & PHHAL_HW_PN512_BIT_CRYPTO1ON)
        {
    ...
    case PHHAL_HW_CONFIG_RXBUFFER_BUFSIZE:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_GetRxBuffer(pDataParams, PH_ON, &pBuffer, &wBufferLen, &wBufferSize));
    ...
    case PHHAL_HW_CONFIG_SERIAL_BITRATE:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_SERIALSPEED, &bRegister));

        switch (bRegister)
        {
        case PHHAL_HW_PN512_SERIALSPEED_9600:
            *pValue = PHHAL_HW_RS232_BITRATE_9600;
            break;
        case PHHAL_HW_PN512_SERIALSPEED_19200:
            *pValue = PHHAL_HW_RS232_BITRATE_19200;
            break;
        case PHHAL_HW_PN512_SERIALSPEED_38400:
            *pValue = PHHAL_HW_RS232_BITRATE_38400;
            break;
        case PHHAL_HW_PN512_SERIALSPEED_57600:
            *pValue = PHHAL_HW_RS232_BITRATE_57600;
            break;
        case PHHAL_HW_PN512_SERIALSPEED_115200:
            *pValue = PHHAL_HW_RS232_BITRATE_115200;
            break;
        case PHHAL_HW_PN512_SERIALSPEED_230400:
            *pValue = PHHAL_HW_RS232_BITRATE_230400;
            break;
        case PHHAL_HW_PN512_SERIALSPEED_460800:
    ...
    case PHHAL_HW_CONFIG_EXT_RF_ON:
        /* Retrieve Status register */
        PH_CHECK_SUCCESS_FCT(statusTmp, 
            phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_DIVIRQ, &bRegister));

        if (bRegister & PHHAL_HW_PN512_BIT_EXT_RF_OFF)
        {
            /* Clear the EXT_RF_ON and EXT_RF_OFF bits*/
            bRegister = 0x03;

            PH_CHECK_SUCCESS_FCT(statusTmp,
                phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_DIVIRQ, bRegister));
        }
        ...
        /* Check EXT_RF_ON bit */
        if (bRegister & PHHAL_HW_PN512_BIT_EXT_RF_ON)
        {
    ...
    case PHHAL_HW_CONFIG_RX_FRAME_MODE:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp,
            phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, &bRegister));
    ...
    case PHHAL_HW_CONFIG_RXSPEED:
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_RXMODE, &bRegister));
        *pValue = bRegister & PHHAL_HW_PN512_MASK_SPEED;
        break;
                                 ...
                                 )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, &bTxControlReg));

    /* Switch on the field again */
    bTxControlReg |= PHHAL_HW_PN512_BIT_TX1RFEN | PHHAL_HW_PN512_BIT_TX2RFEN;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, bTxControlReg));
                                  ...
                                  )
{
    ...
    /* Switch off the field */
    bTxControlReg &= (uint8_t)~(uint8_t)(PHHAL_HW_PN512_BIT_TX1RFEN | PHHAL_HW_PN512_BIT_TX2RFEN);
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, bTxControlReg));
                                    ...
                                    )
{
    ...
    /* Switch off the field */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_FieldOff(pDataParams));

    /* wait for field-off timeout */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_Wait(
        pDataParams,
        PHHAL_HW_TIME_MILLISECONDS,
        pDataParams->wFieldOffTime));

    /* switch on the field again */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_FieldOn(pDataParams));
                              ...
                              )
{
    ...
    /* Retrieve RxDataRate */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_GetConfig(pDataParams, PHHAL_HW_CONFIG_RXDATARATE, &wTimerShift));
    ++wTimerShift;

    /* Calculate timershift */
    wTimerShift = (uint16_t)(PHHAL_HW_PN512_TIMER_SHIFT * (PHHAL_HW_PN512_ETU_106 / (float32_t)wTimerShift));
    ...
    do
    {
        ...
        if (bUnit == PHHAL_HW_TIME_MICROSECONDS)
        {
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetFdt(pDataParams, PHHAL_HW_TIME_MICROSECONDS, wTimeoutNew));
            wTimeout = 0;
        }
        else
        {
            /* Timer would overflow -> use maximum value and decrement overall value for next iteration */
            if (wTimeout > ((PHHAL_HW_PN512_TIMER_MAX_VALUE_US / 1000) - 1))
            {
                wTimeoutNew = (PHHAL_HW_PN512_TIMER_MAX_VALUE_US / 1000) - 1;
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetFdt(pDataParams, PHHAL_HW_TIME_MILLISECONDS, wTimeoutNew));
                wTimeout = wTimeout - wTimeoutNew;
            }
            /* No overflow -> set the complete time */
            else
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_SetFdt(pDataParams, PHHAL_HW_TIME_MILLISECONDS, wTimeout));
                wTimeout = 0;
            }
        }
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_COMMIEN, PHHAL_HW_PN512_BIT_TIMERI));

        /* clear all irq flags */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_COMMIRQ, (uint8_t)~(uint8_t)PHHAL_HW_PN512_BIT_SET));
        ...
        bIrq0Wait = PHHAL_HW_PN512_BIT_ERRI | PHHAL_HW_PN512_BIT_TIMERI;
        bIrq1Wait = 0x00;
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_WaitIrq(pDataParams, bIrq0Wait, bIrq1Wait, &bRegister, &bRegister));
    ...
    )
{
    ...
    return phhalHw_Pn512_MfcAuthenticate(pDataParams, bBlockNo, bKeyType, aKey, pUid);
#else
    /* satisfy compiler */
    ...
    )
{
    ...
    if (bKeyType == PHHAL_HW_MFC_KEYA)
    {
        ...
        bFifoData[wFifoDataLen++] = PHHAL_HW_PN512_MFC_AUTHA_CMD;
    }
    else if (bKeyType == PHHAL_HW_MFC_KEYB)
    {
        /* Set authentication command code */
        bFifoData[wFifoDataLen++] = PHHAL_HW_PN512_MFC_AUTHB_CMD;
    }
    else
    {
        return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_COMMIEN, PHHAL_HW_PN512_BIT_TIMERI | PHHAL_HW_PN512_BIT_IDLEI));

    /* write command data into FiFo buffer */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn512_WriteFifo(pDataParams, bFifoData, wFifoDataLen, &wFifoDataLen));

    /* clear all irq flags */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_COMMIRQ, (uint8_t)~(uint8_t)PHHAL_HW_PN512_BIT_SET));

    /* write the command into the command register */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_PN512_REG_COMMAND, PHHAL_HW_PN512_CMD_AUTHENT));

    /* wait until command is finished */
    bIrq0Wait = PHHAL_HW_PN512_BIT_RXI | PHHAL_HW_PN512_BIT_ERRI | PHHAL_HW_PN512_BIT_TIMERI | PHHAL_HW_PN512_BIT_IDLEI;
    status = phhalHw_Pn512_WaitIrq(pDataParams, bIrq0Wait, bIrq1Wait,&bRegister,&bIrq1Rq);
    ...
    /* Check for timeout */
    if (bRegister & PHHAL_HW_PN512_BIT_TIMERI)
    {
    ...
    /* Check auth success */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_STATUS2, &bRegister));
    if ((bRegister & PHHAL_HW_PN512_BIT_CRYPTO1ON) != PHHAL_HW_PN512_BIT_CRYPTO1ON)
    {
                                   ...
                                   )
{
    ...
    if (wValue == PH_ON)
    {
        ...
        PH_CHECK_SUCCESS_FCT(status, phhalHw_Pn512_GetConfig(pDataParams, 
        ...
        /* Calculate values for Microsecond values */
        PH_CHECK_SUCCESS_FCT(status, phhalHw_Pn512_SetConfig(pDataParams, 
                                  ...
                                  )
{
    ...
    bReg = bRegister;
    bRegister |= (PHHAL_HW_PN512_BIT_TX2RFAutoEN | PHHAL_HW_PN512_BIT_TX1RFAutoEN
        | PHHAL_HW_PN512_BIT_AUTORF_OFF | PHHAL_HW_PN512_BIT_CA_ON);
    ...
    {
        bIrq0WaitFor = PHHAL_HW_PN512_BIT_IDLEI | PHHAL_HW_PN512_BIT_ERRI | PHHAL_HW_PN512_BIT_TIMERI;
    }
    bIrq1WaitFor = 0x00;
    ...
    if (status == PH_ERR_SUCCESS)
    {
        ...
        if(!(bStatus2 & PHHAL_HW_PN512_BIT_TARGET_ACTIVATED))
        {
            /*TODO : Check if time delay is required before checking PHHAL_HW_PN512_REG_TXCONTROL Reg values for TX2RFEN and TX1RFEN */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_PN512_REG_TXCONTROL, &bReg));
            if (bReg & (PHHAL_HW_PN512_BIT_TX2RFEN | PHHAL_HW_PN512_BIT_TX1RFEN))
            {
