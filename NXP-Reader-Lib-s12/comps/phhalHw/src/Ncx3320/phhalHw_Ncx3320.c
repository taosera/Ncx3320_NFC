...
/** \file
* NCx3320 specific HAL-Component of Reader Library Framework.
* $Author: nxp66431 $
* $Revision: 339 $
* $Date: 2013-08-10 11:55:44 +0530 (Sat, 10 Aug 2013) $
*
* History:
...
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_I14443a[][2] =
{
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3320_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_ASK100,                PH_ON}
};

/** Default shadow for ISO14443-3B Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_I14443b[][2] =
{
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3320_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3320_MODINDEX_I14443B},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/** Default shadow for FeliCa Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_Felica[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3320_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3320_MODINDEX_FELICA},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/** Default shadow for ISO15693 Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_I15693[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3320_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3320_MODINDEX_I15693},
    {PHHAL_HW_CONFIG_ASK100,                PH_ON}
};

/** Default shadow for ICode EPC/UID Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_EpcUid[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_OFF},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_OFF},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3320_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3320_MODINDEX_EPCUID},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/** Default shadow for ISO18000-3 Mode3 */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_I18000p3m3[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_OFF},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
    ...
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,      PHHAL_HW_NCx3320_DEFAULT_TIMEOUT},
    {PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS,      0x0000},
    {PHHAL_HW_CONFIG_MODINDEX,              PHHAL_HW_NCx3320_MODINDEX_I18000P3M3},
    {PHHAL_HW_CONFIG_ASK100,                PH_OFF}
};

/** Default shadow for ISO18092 Passive Initiator Mode */
static const uint16_t PH_MEMLOC_CONST_ROM wNcx3320_DefaultShadow_I18092mPI[][2] =
{
    {PHHAL_HW_CONFIG_PARITY,                PH_ON},
    {PHHAL_HW_CONFIG_TXCRC,                 PH_ON},
    {PHHAL_HW_CONFIG_RXCRC,                 PH_ON},
...
phStatus_t phhalHw_Ncx3320_Init(
...
{
    if (sizeof(phhalHw_Ncx3320_DataParams_t) != wSizeOfDataParams)
    {
    ...
    /* Init. private data */
    pDataParams->wId                    = PH_COMP_HAL | PHHAL_HW_NCx3320_ID;
    ...
    pDataParams->bFifoSize              = PHHAL_HW_NCx3320_VALUE_FIFOSIZE_255;
    pDataParams->wMaxPrecachedBytes     = PHHAL_HW_NCx3320_PRECACHED_BYTES;
    ...
    /* Reset subcarrier setting, needed for phhalHw_Ncx3320_SetCardMode */
    pDataParams->wCfgShadow[PHHAL_HW_CONFIG_SUBCARRIER] = PHHAL_HW_SUBCARRIER_SINGLE;

    return phbalReg_SetConfig(pDataParams->pBalDataParams, PHBAL_REG_CONFIG_HAL_HW_TYPE, PHBAL_REG_HAL_HW_NCx3320);
}
                                  ...
                                  )
{
        ...
        (pDataParams->bBalConnectionType == PHHAL_HW_BAL_CONNECTION_I2C))
    {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetTxBuffer(pDataParams, PH_ON, &pTmpBuffer, &wTmpBufferLen, &wTmpBufferSize));
    ...
    if ((wTmpBufferLen == 0) && (wTxLength == 0))
    {
        ...
        /* Disable DataEn */
        bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_BIT_DATAEN;
    ...
    if (wNumPrecachedBytes > 0)
    {
        ...
        status = phhalHw_Ncx3320_WriteFifo(pDataParams, pTmpBuffer, wNumPrecachedBytes, &wFifoBytes);
    ...
    /* start the command */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_COMMAND, PHHAL_HW_NCx3320_CMD_TRANSCEIVE));
    ...
    while ((wTmpBufferLen != 0) || (wTxLength != 0))
    {
        ...
        if ((bIrq0Reg & PHHAL_HW_NCx3320_BIT_IDLEIRQ) || (bIrq0Reg & PHHAL_HW_NCx3320_BIT_TXIRQ))
        {
            /* stop the command */
        ...
        status = phhalHw_Ncx3320_WriteFifo(pDataParams, pTmpBuffer, wTmpBufferLen, &wFifoBytes);
    ...
    /* Set wait IRQs */
    bIrq0WaitFor = PHHAL_HW_NCx3320_BIT_TXIRQ | PHHAL_HW_NCx3320_BIT_IDLEIRQ;
    ...
    if (!(bIrq0Reg & PHHAL_HW_NCx3320_BIT_IDLEIRQ) && !(bIrq0Reg & PHHAL_HW_NCx3320_BIT_ERRIRQ))
    {
        /* Clear high-alert irq flag */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ0, PHHAL_HW_NCx3320_BIT_HIALERTIRQ));

        /* Change wait IRQs */
        bIrq0WaitFor = PHHAL_HW_NCx3320_BIT_RXIRQ | PHHAL_HW_NCx3320_BIT_HIALERTIRQ | PHHAL_HW_NCx3320_BIT_IDLEIRQ | PHHAL_HW_NCx3320_BIT_EMDIRQ;
    ...
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetConfig(pDataParams, PHHAL_HW_CONFIG_TXLASTBITS, 0x00));
    }
    ...
    if (bNoData != PH_OFF)
    {
        ...
        /* Enable DataEn */
        bRegister |= PHHAL_HW_NCx3320_BIT_DATAEN;
    ...
    /* Timeout handling */
    if ((bIrq1Reg & PHHAL_HW_NCx3320_BIT_TIMER1IRQ) && !(bIrq0Reg & PHHAL_HW_NCx3320_BIT_EMDIRQ))
    {
        ...
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_FieldReset(pDataParams));
        }
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetRxBuffer(pDataParams, PH_ON, &pTmpBuffer, &wTmpBufferLen, &wTmpBufferSize));
    ...
    if (status == PH_ERR_SUCCESS)
    {
        ...
        do
        {
            do
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_STATUS, &bStatus2));
            }
            while (!(bIrq0Reg & bIrq0WaitFor) && !(bIrq1Reg & bIrq1WaitFor) && (bStatus2 & 0x07));
        ...
        /* framing error */
        else if (bError & PHHAL_HW_NCx3320_BIT_MINFRAMEERR)
        {
            status = PH_ERR_FRAMING_ERROR;
        }
        /* collision */
        else if (bError & PHHAL_HW_NCx3320_BIT_COLLDET)
        {
            ...
            else
            {
                ...
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXCOLL, &bRegister));

                /* check if collpos is valid */
                if (bRegister & PHHAL_HW_NCx3320_BIT_COLLPOSVALID)
                {
                    /* retrieve collpos */
                    bRegister &= PHHAL_HW_NCx3320_MASK_COLLPOS;
                }
                else
                {
                ...
                bRegister &= PHHAL_HW_NCx3320_MASK_RXLASTBITS;
        ...
        /* protocol error */
        else if (bError & PHHAL_HW_NCx3320_BIT_PROTERR)
        {
            status = PH_ERR_PROTOCOL_ERROR;
        }
        /* CRC / parity error */
        else if (bError & PHHAL_HW_NCx3320_BIT_INTEGERR)
        {
    ...
    if (status == PH_ERR_SUCCESS)
    {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITCTRL, &bRegister));
    ...
    {
        /* Calculate FDT Value */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetFdt(pDataParams, status, &dwTimingSingle));
    ...
    )
{
    ...
    /* Check the NCx3320 derivative type by reading the manufacturer info page in the EEPROM*/
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Cmd_ReadE2(pDataParams, 0, 2, pDerivate)); 
    ...
    case PHHAL_HW_CARDTYPE_ISO14443A:
        if((wDerivate == PHHAL_HW_CLNCx3320_PRODUCT_ID) || (wDerivate == PHHAL_HW_MFRC631_PRODUCT_ID) 
            || (wDerivate == PHHAL_HW_MFRC630_PRODUCT_ID))
        {

            /* Use 14443a default shadow */
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_I14443a;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_I14443a) / (sizeof(uint16_t) * 2);
        }
        else
        {
    ...
    case PHHAL_HW_CARDTYPE_ISO14443B:
        ...
        {
            /* Use 14443b shadow */
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_I14443b;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_I14443b) / (sizeof(uint16_t) * 2);
        }
        else
        {
            return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_HAL);
    ...
    case PHHAL_HW_CARDTYPE_FELICA:
        if(wDerivate == PHHAL_HW_CLNCx3320_PRODUCT_ID)
        {
            /* Use Felica shadow */
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_Felica;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_Felica) / (sizeof(uint16_t) * 2);
        }
        else
        {
            return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_HAL);
    ...
    case PHHAL_HW_CARDTYPE_ISO15693:
        if((wDerivate == PHHAL_HW_CLNCx3320_PRODUCT_ID) || (wDerivate == PHHAL_HW_SLRC610_PRODUCT_ID))
        {
            /* Use ISO15693 shadow */
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_I15693;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_I15693) / (sizeof(uint16_t) * 2);
        }
        else
        {
            return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_HAL);
    ...
    case PHHAL_HW_CARDTYPE_ICODEEPCUID:
        ...
        {
            /* Use EPC/UID shadow */
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_EpcUid;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_EpcUid) / (sizeof(uint16_t) * 2);
        }
        else
        {
            return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_HAL);
    ...
    case PHHAL_HW_CARDTYPE_I18000P3M3:
        if((wDerivate == PHHAL_HW_CLNCx3320_PRODUCT_ID) || (wDerivate == PHHAL_HW_SLRC610_PRODUCT_ID))
        {
            ...
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_I18000p3m3;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_I18000p3m3) / (sizeof(uint16_t) * 2);

            /* Set default start symbol */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetConfig(pDataParams, PHHAL_HW_CONFIG_SYMBOL_START, PHHAL_HW_SYMBOL_I18000P3M3_FSYNC));
        }
        else
        {
            return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_HAL);
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_EPCV2_Init(pDataParams));
        break;
    ...
    case PHHAL_HW_CARDTYPE_I18092MPI:
        if(wDerivate == PHHAL_HW_CLNCx3320_PRODUCT_ID)
        {
            ...
            pShadowDefault = (uint16_t*)wNcx3320_DefaultShadow_I18092mPI;
            wShadowCount = sizeof(wNcx3320_DefaultShadow_I18092mPI) / (sizeof(uint16_t) * 2);
        }
        else
        {
            return PH_ADD_COMPCODE(PH_ERR_USE_CONDITION, PH_COMP_HAL);
    ...
    if (bCardType != PHHAL_HW_CARDTYPE_CURRENT)
    {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
            pDataParams,
            PHHAL_HW_NCx3320_REG_T0CONTROL,
            PHHAL_HW_NCx3320_BIT_TAUTORESTARTED | PHHAL_HW_NCx3320_BIT_TSTOP_RX | PHHAL_HW_NCx3320_BIT_TSTART_TX | PHHAL_HW_NCx3320_VALUE_TCLK_1356_MHZ));

        /* Configure T1 and cascade it with T0 */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
            pDataParams,
            PHHAL_HW_NCx3320_REG_T1CONTROL,
            PHHAL_HW_NCx3320_BIT_TSTOP_RX | PHHAL_HW_NCx3320_BIT_TSTART_TX | PHHAL_HW_NCx3320_VALUE_TCLK_T0));

        /* Configure T2 for LFO AutoTrimm */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
            pDataParams,
            PHHAL_HW_NCx3320_REG_T2CONTROL,
            PHHAL_HW_NCx3320_BIT_TSTART_LFO | PHHAL_HW_NCx3320_VALUE_TCLK_1356_MHZ));

        /* T2 reload value for LFO AutoTrimm*/
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_T2RELOADHI, 0x03));
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_T2RELOADLO, 0xFF));

        /* Configure T3 (for LPCD/ AutoTrimm) */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
            pDataParams,
            PHHAL_HW_NCx3320_REG_T3CONTROL,
            PHHAL_HW_NCx3320_VALUE_TCLK_1356_MHZ));

        /* Set FiFo-Size and Waterlevel */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetConfig(
            pDataParams,
            PHHAL_HW_NCx3320_CONFIG_FIFOSIZE,
            (uint16_t)pDataParams->bFifoSize));

        /* Init. RxBitCtrl register */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITCTRL, PHHAL_HW_NCx3320_BIT_VALUESAFTERCOLL));

        /* Init RxSOFD register */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXSOFD, 0x00));
    ...
    if (bUseDefaultShadow)
    {
        ...
        memset(pDataParams->wCfgShadow, 0x00, PHHAL_HW_NCx3320_SHADOW_COUNT);  /* PRQA S 3200 */
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetCardMode(
        pDataParams,
    ...
    for (wIndex = 0; wIndex < wShadowCount; ++wIndex)
    {
        ...
        switch (wConfig)
        {
            /* The following have been already set by phhalHw_Ncx3320_SetCardMode */
        ...
        case PHHAL_HW_CONFIG_TIMEOUT_VALUE_US:
            ...
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetConfig(pDataParams, wConfig, pDataParams->wCfgShadow[wConfig]));
            }
            break;
                                   ...
                                   )
{
    ...
    case PHHAL_HW_CONFIG_ASK100:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetConfig_Int(pDataParams, wConfig, wValue));
    ...
    case PHHAL_HW_CONFIG_FRAME_SYNC:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_FRAMECON, 0x02));
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXCRCCON, 0x7B));
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXCRCCON, 0x7B));
        break;

    case PHHAL_HW_CONFIG_TXDATANUM:

        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXDATANUM, (uint8_t)wValue));
        break;

    case PHHAL_HW_CONFIG_RXALIGN:

        /* check parameter */
        if (wValue > (PHHAL_HW_NCx3320_MASK_RXALIGN >> 4))
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }

        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITCTRL, &bRegister));
        bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_MASK_RXALIGN;
        bValue |= (uint8_t)(wValue << 4);

        /* Only perform the operation, if the new value is different */
        if (bValue != bRegister)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_RXBITCTRL, bValue));
        }
    ...
    case PHHAL_HW_CONFIG_RXDEAFBITS:
        ...
        /* Set RxWait */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetRxWait(pDataParams, wValue));
    ...
    case PHHAL_HW_CONFIG_TXWAIT_US:
        ...
        /* Set TxWait */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetTxWait(pDataParams, wValue));
    ...
    case PHHAL_HW_CONFIG_CLEARBITSAFTERCOLL:
        ...
        if (wValue == PH_OFF)
        {
            bValue = bRegister | PHHAL_HW_NCx3320_BIT_VALUESAFTERCOLL;
        }
        /* Enable */
        else
        {
            bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_BIT_VALUESAFTERCOLL;
        }
    ...
    case PHHAL_HW_CONFIG_MODINDEX:
        ...
        /* Parameter masking */
        wValue &= PHHAL_HW_NCx3320_MASK_RESIDUAL_CARRIER;

        /* Read out TxAmp register */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXAMP, &bRegister));

        /* Set modulation index value */
        bValue = (bRegister & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_MASK_RESIDUAL_CARRIER) | (uint8_t)wValue;

        /* Only perform the operation, if the new value is different */
        if (bValue != bRegister)
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TXAMP, bValue));
        }
    ...
    case PHHAL_HW_CONFIG_TIMEOUT_VALUE_MS:
        ...
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetFdt(pDataParams, PHHAL_HW_TIME_MICROSECONDS, wValue));
            pDataParams->bTimeoutUnit = PHHAL_HW_TIME_MICROSECONDS;
        }
        /* Calculate values for Millisecond values */
        else
        {
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetFdt(pDataParams, PHHAL_HW_TIME_MILLISECONDS, wValue));
    ...
    case PHHAL_HW_CONFIG_SYMBOL_START:
        ...
        bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_MASK_STARTSYM;

        /* Set new symbol */
        switch (pDataParams->bSymbolStart)
        {
        case PHHAL_HW_SYMBOL_ICODEEPCUID_SSOF:
            bValue |= PHHAL_HW_NCx3320_VALUE_START_SYM2;
            break;
        case PHHAL_HW_SYMBOL_ICODEEPCUID_LSOF:
            bValue |= PHHAL_HW_NCx3320_VALUE_START_SYM0;
            break;
        case PHHAL_HW_SYMBOL_ICODEEPCUID_CS:
            bValue |= PHHAL_HW_NCx3320_VALUE_START_SYM1;
            break;
        case PHHAL_HW_SYMBOL_I15693_SOF:
            bValue |= PHHAL_HW_NCx3320_VALUE_START_SYM2;
            break;
    ...
    case PHHAL_HW_CONFIG_SYMBOL_END:
        ...
        /* Read out TxFrameCon register */
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_FRAMECON, &bRegister));
        bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_MASK_STOPSYM;

        /* Set new symbol */
        switch (pDataParams->bSymbolEnd)
        {
        case PHHAL_HW_SYMBOL_ICODEEPCUID_CEOF:
            bValue |= PHHAL_HW_NCx3320_VALUE_STOP_SYM3;
            break;
        default:
            break;
        }
    ...
    case PHHAL_HW_CONFIG_DISABLE_MF_CRYPTO1:
        ...
        if (wValue != PH_OFF)
        {
            ...
            /* Clear Crypto1On bit */
            bValue = bRegister & (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_BIT_CRYPTO1ON;

            /* Only perform the operation, if the new value is different */
            if (bValue != bRegister)
            {
                PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_STATUS, bValue));
            }
        }
        break;
    ...
    case PHHAL_HW_CONFIG_RXBUFFER_STARTPOS:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetRxBuffer(pDataParams, PH_ON, &pBuffer, &wBufferLen, &wBufferSize));
    ...
    case PHHAL_HW_CONFIG_TXBUFFER_LENGTH:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_GetTxBuffer(pDataParams, PH_ON, &pBuffer, &wBufferLen, &wBufferSize));
    ...
    case PHHAL_HW_CONFIG_MAX_PRECACHED_BYTES:
        ...
        /* Check parameter */
        if (((pDataParams->bFifoSize == PHHAL_HW_NCx3320_VALUE_FIFOSIZE_255) && (wValue > 0xFF)) ||
            ((pDataParams->bFifoSize == PHHAL_HW_NCx3320_VALUE_FIFOSIZE_512) && (wValue > 0x200)))
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
    ...
    case PHHAL_HW_CONFIG_SERIAL_BITRATE:
        ...
        case PHHAL_HW_RS232_BITRATE_7200:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_7200;
            break;
        case PHHAL_HW_RS232_BITRATE_9600:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_9600;
            break;
        case PHHAL_HW_RS232_BITRATE_14400:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_14400;
            break;
        case PHHAL_HW_RS232_BITRATE_19200:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_19200;
            break;
        case PHHAL_HW_RS232_BITRATE_38400:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_38400;
            break;
        case PHHAL_HW_RS232_BITRATE_57600:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_57600;
            break;
        case PHHAL_HW_RS232_BITRATE_115200:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_115200;
            break;
        case PHHAL_HW_RS232_BITRATE_128000:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_128000;
            break;
        case PHHAL_HW_RS232_BITRATE_230400:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_230400;
            break;
        case PHHAL_HW_RS232_BITRATE_460800:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_460800;
            break;
        case PHHAL_HW_RS232_BITRATE_921600:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_921600;
            break;
        case PHHAL_HW_RS232_BITRATE_1228800:
            bRegister = PHHAL_HW_NCx3320_SERIALSPEED_1228800;
            break;
        default:
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_SERIALSPEED, bRegister));
        break;
    ...
    case PHHAL_HW_NCx3320_CONFIG_FIFOSIZE:

        /* configure the water level */
        if (wValue == PHHAL_HW_NCx3320_VALUE_FIFOSIZE_255)
        {
            /* Set 255 bytes and clear Waterlevel High-Bit */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
                pDataParams,
                PHHAL_HW_NCx3320_REG_FIFOCONTROL,
                PHHAL_HW_NCx3320_BIT_FIFOSIZE | PHHAL_HW_NCx3320_BIT_FLUSHFIFO));

            /* Also reset max. precached bytes if neccessary */
            if (pDataParams->wMaxPrecachedBytes > PHHAL_HW_NCx3320_PRECACHED_BYTES)
            {
                pDataParams->wMaxPrecachedBytes = PHHAL_HW_NCx3320_PRECACHED_BYTES;
            }
            ...
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
                pDataParams,
                PHHAL_HW_NCx3320_REG_WATERLEVEL,
                0xFE));
        }
        else if (wValue == PHHAL_HW_NCx3320_VALUE_FIFOSIZE_512)
        {
            /* Set 512 bytes and Waterlevel High-Bit */
            PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(
                pDataParams,
                PHHAL_HW_NCx3320_REG_FIFOCONTROL,
                PHHAL_HW_NCx3320_BIT_FLUSHFIFO | PHHAL_HW_NCx3320_BIT_WATERLEVEL_HI));
    ...
    case PHHAL_HW_NCx3320_CONFIG_LOADREG_MODE:
    ...
    case PHHAL_HW_CONFIG_SETMINFDT:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetMinFDT(pDataParams, wValue));
        break;
                                   ...
                                   )
{
    ...
    case PHHAL_HW_CONFIG_SERIAL_BITRATE:
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_SERIALSPEED, &bRegister));

        switch (bRegister)
        {
        case PHHAL_HW_NCx3320_SERIALSPEED_7200:
            *pValue = PHHAL_HW_RS232_BITRATE_7200;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_9600:
            *pValue = PHHAL_HW_RS232_BITRATE_9600;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_14400:
            *pValue = PHHAL_HW_RS232_BITRATE_14400;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_19200:
            *pValue = PHHAL_HW_RS232_BITRATE_19200;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_38400:
            *pValue = PHHAL_HW_RS232_BITRATE_38400;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_57600:
            *pValue = PHHAL_HW_RS232_BITRATE_57600;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_115200:
            *pValue = PHHAL_HW_RS232_BITRATE_115200;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_128000:
            *pValue = PHHAL_HW_RS232_BITRATE_128000;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_230400:
            *pValue = PHHAL_HW_RS232_BITRATE_230400;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_460800:
            *pValue = PHHAL_HW_RS232_BITRATE_460800;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_921600:
            *pValue = PHHAL_HW_RS232_BITRATE_921600;
            break;
        case PHHAL_HW_NCx3320_SERIALSPEED_1228800:
                                 ...
                                 )
{
    ...
    /* Enable Drivers */
    bRegister |= PHHAL_HW_NCx3320_BIT_TXEN;

    /* Write DrvMode register */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_DRVMODE, bRegister));
                                  ...
                                  )
{
    ...
    /* Disable Drivers */
    bRegister &= (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_BIT_TXEN;
                                    ...
                                    )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_FieldOff(pDataParams));

    /* wait for field-off timeout */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Wait(
        pDataParams,
        PHHAL_HW_TIME_MILLISECONDS,
        pDataParams->wFieldOffTime));

    /* switch on the field again */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_FieldOn(pDataParams));
    //I_swear();
                              ...
                              )
{
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetFdt(pDataParams, bUnit, wTimeout));

    /* retrieve content of Timer Control register */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_ReadRegister(pDataParams, PHHAL_HW_NCx3320_REG_TCONTROL, &bControlReg));

    /* clear all irq flags */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_IRQ1, (uint8_t)~(uint8_t)PHHAL_HW_NCx3320_BIT_SET));

    /* manually start T0 */
    bControlReg |= PHHAL_HW_NCx3320_BIT_T0STARTSTOPNOW | PHHAL_HW_NCx3320_BIT_T0RUNNING;
    /* manually start T1 */
    bControlReg |= PHHAL_HW_NCx3320_BIT_T1STARTSTOPNOW | PHHAL_HW_NCx3320_BIT_T1RUNNING;
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TCONTROL, bControlReg));

    /* wait for timer interrupt */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_WaitIrq(pDataParams, PH_ON, PH_OFF, 0x00, PHHAL_HW_NCx3320_BIT_TIMER1IRQ, NULL, &bIrqRq));

    /* manually stop T0 */
    bControlReg &= (uint8_t)~(uint8_t)(PHHAL_HW_NCx3320_BIT_T0RUNNING | PHHAL_HW_NCx3320_BIT_T1RUNNING);
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_WriteRegister(pDataParams, PHHAL_HW_NCx3320_REG_TCONTROL, bControlReg));

    /* Restore previous timeout */
    if (pDataParams->bTimeoutUnit == PHHAL_HW_TIME_MICROSECONDS)
    {
        PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_SetFdt(
            pDataParams,
    ...
    )
{
    ...
    {
        /* check key number */
        if (wKeyNo >= (PHHAL_HW_NCx3320_MAX_NUM_KEYS >> 1))
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
    ...
    {
        /* check key number */
        if (wKeyNo >= ((PHHAL_HW_NCx3320_MAX_NUM_KEYS >> 1) - 1))
        {
            return PH_ADD_COMPCODE(PH_ERR_INVALID_PARAMETER, PH_COMP_HAL);
        }
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Cmd_LoadKeyE2(
        pDataParams,
        bKeyNoInt));

    /* execute Authenticate command */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_MfcAuthenticate_Int(
        pDataParams,
        bBlockNo,
        bKeyType,
        pUid));
    ...
    )
{
    ...
    /* load key directly */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Ncx3320_Cmd_LoadKey(
        pDataParams,
        pKey));
    ...
    )
{
    ...
    if (wValue == PH_ON)
    {
        ...
        PH_CHECK_SUCCESS_FCT(status, phhalHw_Ncx3320_GetConfig(pDataParams, 
        ...
        PH_CHECK_SUCCESS_FCT(status, phhalHw_Ncx3320_SetConfig(pDataParams, 
