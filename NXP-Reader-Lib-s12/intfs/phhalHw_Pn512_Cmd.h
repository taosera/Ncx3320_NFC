...
#ifndef PHHALHW_PN512_CMD_H
#define PHHALHW_PN512_CMD_H
...
/** \defgroup phhalHw_Pn512_Cmd Commands
...
* It can be retrieved using the function \ref phhalHw_Pn512_Cmd_Mem.
*
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlaying component.
