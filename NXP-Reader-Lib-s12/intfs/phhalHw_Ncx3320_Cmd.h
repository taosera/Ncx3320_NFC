...
#ifndef PHHALHW_NCx3320_CMD_H
#define PHHALHW_NCx3320_CMD_H
...
/** \defgroup phhalHw_Ncx3320_Cmd Commands
...
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_DEFAULT            0x00U
...
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_POWERDOWN          0x01U

/**
Same as #PHHAL_HW_NCx3320_CMD_LPCD_MODE_POWERDOWN, but uses the timeout set with
...
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_POWERDOWN_GUARDED  0x02U

/**
Or this bit to the desired mode to perform LPO trimming together with the command.
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_OPTION_TRIMM_LPO   0x80U

/**
Or this bit to the desired mode to prevent the function to set I and Q channel values.
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_OPTION_IGNORE_IQ   0x40U

/**
Mask for option bits within Mode byte.
*/
#define PHHAL_HW_NCx3320_CMD_LPCD_MODE_OPTION_MASK        0xF0U
/*@}*/
...
* The values can directly be used as parameters for the \ref phhalHw_Ncx3320_Cmd_Lpcd function.
* \return Status code
...
/**
* \brief Performs a query, an Ack and a Req-Rn.
*
* \return Status code
* \retval #PH_ERR_SUCCESS Operation successful.
* \retval Other Depending on implementation and underlaying component.
...
phStatus_t phhalHw_Ncx3320_Cmd_AckReq(
                                    ...
                                    uint16_t * wRxBufferLen                        /**< [Out]Length of the Data read. */
                                    );
...
phStatus_t phhalHw_Ncx3320_Cmd_LoadProtocol(
    phhalHw_Ncx3320_DataParams_t * pDataParams,   /**< [In] Pointer to this layer's parameter structure. */
    uint8_t bTxProtocol,                        /**< [In] Tx-Protocol (see PHHAL_HW_NCx3320_RXTX_* defines). */
    uint8_t bRxProtocol                         /**< [In] Rx-Protocol (see PHHAL_HW_NCx3320_RXTX_* defines). */
    );
