...
typedef struct
{
    ...
    uint16_t       wHalType;	/**< HAL HW type (Pn512, Ncx3320, ... ) */
...
*/
/*@{*/
#define PHBAL_REG_HAL_HW_PN512              0x0000U     /**< Pn512 HW */
#define PHBAL_REG_HAL_HW_NCx3320              0x0001U     /**< Ncx3320 HW */
#define PHBAL_REG_STUBI2C_CONFIG_IC_PN512   0x0000U     /**< peridot 1.5*/
#define PHBAL_REG_STUBI2C_CONFIG_IC_NCx3320   0x0001U     /**< peridot 2.0 */
/*@}*/
