...
#define PHHAL_HW_NCx3320_ID               0x01    /**< ID for Ncx3320 HAL component. */
...
#define PHHAL_HW_NCx3320_CONFIG_FIFOSIZE      (PH_CONFIG_CUSTOM_BEGIN)
    ...
    */
#define PHHAL_HW_NCx3320_CONFIG_LOADREG_MODE  (PH_CONFIG_CUSTOM_BEGIN+1)
    /*@}*/
    ...
    */
    /*@{*/
#define PHHAL_HW_NCx3320_VALUE_FIFOSIZE_255   0x0000U /**< Configure FIFO-Size to 256 bytes */
#define PHHAL_HW_NCx3320_VALUE_FIFOSIZE_512   0x0001U /**< Configure FIFO-Size to 512 bytes */
    /*@}*/

    /** \name Custom Option Bits
    *
    * Can be used for \ref phhalHw_Exchange, \ref phhalHw_Ncx3320_Cmd_Receive and \ref phhalHw_Ncx3320_Cmd_Transmit.
    */
    /*@{*/

    /**
    Do not start timer after transmission / before reception; (only for \ref phhalHw_Ncx3320_Cmd_Receive and \ref phhalHw_Ncx3320_Cmd_Transmit).
    */
#define PHHAL_HW_NCx3320_OPTION_RXTX_TIMER_NOSTART        0x0000U

    /**
    Start timer after transmission / before reception, reset timer counter value; (only for \ref phhalHw_Ncx3320_Cmd_Receive and \ref phhalHw_Ncx3320_Cmd_Transmit).
    */
#define PHHAL_HW_NCx3320_OPTION_RXTX_TIMER_START          0x0010U
    ...
    */
    typedef struct
    {
        ...
        uint8_t * pLoadRegConfig;                           /**< Pointer to configuration buffer for LoadReg mode; Refer to \ref phhalHw_Ncx3320_Init. */
        ...
        uint16_t wCfgShadow[PHHAL_HW_NCx3320_SHADOW_COUNT];   /**< Configuration shadow; Stores configuration for current cardtype. */
...
#include <phhalHw_Ncx3320_Cmd.h>
    ...
    /** \defgroup phhalHw_Pn512 Component : Pn512
    * \brief PN512 Reader HAL
    *
    * Since PN512 and PN512 are quite compatible, the following PN512 features are also supported:\n
    * \li #PHHAL_HW_CARDTYPE_FELICA
    * \li #PHHAL_HW_CARDTYPE_I18092MPI
    * \li #PHHAL_HW_CARDTYPE_I18092MPT
    * \li \ref phhalHw_Pn512_Cmd_Config
    * \li \ref phhalHw_Pn512_Cmd_Autocoll
    *
    ...
    * For other applications it's recommended to use \ref phhalHw_Pn512_Cmd_Transmit and \ref phhalHw_Pn512_Cmd_Receive.
    *
    * @{
    */

#define PHHAL_HW_PN512_ID               0x02    /**< ID for Pn512 HAL component. */

#define PHHAL_HW_PN512_SHADOW_COUNT     0x000FU /**< Number of shadowed configurations. */
    ...
    */
    /*@{*/
    /**
    Do not start timer after transmission / before reception; (only for \ref phhalHw_Pn512_Cmd_Receive and \ref phhalHw_Pn512_Cmd_Transmit).
    */
#define PHHAL_HW_PN512_OPTION_RXTX_TIMER_NOSTART    0x0000U

    /**
    Start timer after transmission / before reception, reset timer counter value; (only for \ref phhalHw_Pn512_Cmd_Receive and \ref phhalHw_Pn512_Cmd_Transmit).
    */
#define PHHAL_HW_PN512_OPTION_RXTX_TIMER_START  0x0010U
    /*@}*/

    /**
    * \brief Pn512 HAL parameter structure
    */
    typedef struct
    {
        uint16_t wId;                                       /**< Layer ID for this component, NEVER MODIFY! */
        ...
        uint16_t wMaxPrecachedBytes;                        /**< Holds the max. number of bytes which are precached prior to command execution. */
        uint8_t bCardType;                                  /**< Type of card for which the hal is configured for. */
        uint16_t wCfgShadow[PHHAL_HW_PN512_SHADOW_COUNT];   /**< Configuration shadow; Stores configuration for current cardtype. */
        uint16_t wTimingMode;                               /**< Current timing measurement mode. */
        uint8_t bTimeoutUnit;                               /**< Unit of current timeout value (either #PHHAL_HW_TIME_MICROSECONDS or #PHHAL_HW_TIME_MILLISECONDS). */
        uint32_t dwTimingUs;                                /**< Current timing value. */
        uint16_t wFieldOffTime;                             /**< Field-Off-Time in milliseconds. */
...
#define PHHAL_HW_CALLBACK_ID    0xAB    /**< ID for Pn512 HAL component. */
...
#define PHHAL_HW_CONFIG_FRAME_SYNC          0x0017U     /**< Set Frame Sync for Ncx3320 */
...
#define PHHAL_HW_OPTION_RXTX_TIMER_START  0x0010U
    /**
    Start the command only (only for \ref phhalHw_Pn512_Cmd_Receive).
    */
#define PHHAL_HW_OPTION_START_CMD_ONLY  0x0020U
    /**
    Read the FIFO contents (only for \ref phhalHw_Pn512_Cmd_Receive).
    */
#define PHHAL_HW_OPTION_FIFO_READ       0x0040U
    /**
    Start the trancieve command, if the option is not specified receive command will be started (only for \ref phhalHw_Pn512_Cmd_Receive).
    */
#define PHHAL_HW_OPTION_START_TRANSCIEVE  0x0080U
    ...
    *
    * \ref phhalHw_Pn512 <em>Special Behaviour:</em>\n
    * If #PHHAL_HW_CARDTYPE_I18092MPT is chosen, Exchange performs the reception BEFORE the transmission.\n
    * For details refer to \ref phhalHw_Pn512.
    *
    * \return Status code
    * \retval #PH_ERR_SUCCESS Operation successful.
