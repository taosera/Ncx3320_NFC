...
#define PH_KEYSTORE_NCx3320_ID            0x02    /**< ID for Ncx3320 KeyStore component. */
#define PH_KEYSTORE_NCx3320_NUM_KEYS      0x80U   /**< Maximum number of keys storable in Ncx3320. */
#define PH_KEYSTORE_NCx3320_NUM_VERSIONS  01U     /**< Amount of versions for each key entry in the key store. */
...
phStatus_t phKeyStore_Ncx3320_Init(
                                 phKeyStore_Ncx3320_DataParams_t * pDataParams,   /**< [In] Pointer to this layer's parameter structure. */
                                 uint16_t wSizeOfDataParams,                    /**< [In] Specifies the size of the data parameter structure. */
                                 void * pHalDataParams                          /**< [In] Pointer to a HAL based on NXP NCx3320 IC. */
                                 );
